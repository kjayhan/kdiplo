...
```{r}
trade <- read_xlsx(here::here("../korea_visits/data/kosis_trade_240330.xlsx"))
...
aid <- read_xlsx(here::here("../covid determinants 220818/data/korea_total_aid_2019_230709.xlsx"))
